...
var Registration = function (_React$Component) {
  ...
  Registration.prototype.onUsernameChange = function onUsernameChange(e) {
    ...
    this.setState({
      username: e.target.value }, function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', { type: 'email', value: this.state.email,
          ...
          React.createElement('input', { type: 'password', value: this.state.conPassword,
